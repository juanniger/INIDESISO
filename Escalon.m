...
% ESCALON M-file for Escalon.fig
...
% Last Modified by GUIDE v2.5 27-Feb-2016 19:15:21
...
function pushbutton1_Callback(hObject, eventdata, handles)
  ...
  global t u;
        ...
        valor_inicial=str2double(get(handles.edit1,'string'));
        valor_final=str2double(get(handles.edit2,'string'));
        tiempo_inicio=str2double(get(handles.edit3,'string'));
        u=sescalon(t,valor_inicial,valor_final,tiempo_inicio);
