...
%IMPULSO M-file for Impulso.fig
...
%
%      IMPULSO('Property','Value',...) creates a new IMPULSO using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to Impulso_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      IMPULSO('CALLBACK') and IMPULSO('CALLBACK',hObject,...) call the
%      local function named CALLBACK in IMPULSO.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 20-Jul-2013 13:19:02
...
function pushbutton1_Callback(hObject, eventdata, handles)
 ...
 global t u;
       ...
       tiempo_impulso=str2double(get(handles.edit2,'string'));
       valor_inicial=str2double(get(handles.edit3,'string'));
       u=simpulso(t,amplitud,valor_inicial,tiempo_impulso);
